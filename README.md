...
- хранит в себе value (2 вида)- Provider & Consumer ссылаются на context, потому что они работают с ним. Provider записывает в него, Consumer получает инфу из него
