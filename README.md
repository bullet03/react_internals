...
Ref:
 ...
 - ref может быть функциональным, рассчитывать его будет сама система реакта в момент вызова, передав в качестве первого параметра этой функции необхлодимый DOMel.
 ...
 - КАРТИНКА с описанием жизненного цикла ref лежит в папке img
___________________________________________________________________________________________________
