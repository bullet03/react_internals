...
- Реконсилиация - СЛОЖНЫЙ термин (наряду с fiber, render). Общая реконсилиация - реконсилиация всего кадра (спрашивают на собеседовании). Частная реконсилиация - сравнение реакт элемента с current fiber. В результате родится дочерний WIP fiber
